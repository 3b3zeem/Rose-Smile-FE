      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex justify-center mb-8">
            <div
              className="relative aspect w-3xl bg-gray-100 overflow-hidden rounded-xl shadow-md cursor-pointer hover:opacity-90 transition"
              onClick={() =>
            ...
            >
              {previewImage || sheet.image?.url ? (
                <img
                  src={previewImage || sheet.image?.url}
                  alt="Preview"
...
export default UpdateSheetImageModal;
